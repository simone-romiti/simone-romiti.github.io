...
Theoretical physicist specialized in lattice QCD and high-performance computing, with proven expertise in Monte Carlo simulations, Machine Learning (PINNs, VAEs), and code optimization. 
...
\begin{large}
  ...
  \item \href{https://inspirehep.net/literature/2613828}{GPU code optimization} $\to$ achieved $\sim 1.5$ improvement by auto-tuning of Multigrid parematers
