...
\setlength{\columnsep}{-4.5cm}
  ...
  \begin{multicols}{2}
    \begin{flushleft}    
      \textbf{Principal Investigator} -- multi-million GPU node-hours compute grants, one at \href{https://www.cscs.ch/computers/alps}{CSCS ALPS} and one at \href{https://www.gauss-centre.eu/}{GCS}
    \end{flushleft}
